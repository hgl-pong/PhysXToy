...
std::shared_ptr<TestSceneBase> CreateTestScene(TestSceneType type)
{
    ...
    case TestSceneType::PHYSX_MASS_PROPERTIES:
        return std::make_shared<PhysXMassPropertiesScene>();
    case TestSceneType::PHYSX_JOINT_SCENE:
    ...
    case TestSceneType::PHYSX_RACK_JOINT_SCENE:
    ...
    case TestSceneType::PHYSX_JOINT_DRIVE_SCENE:
        return std::make_shared<PhysXJointDriveScene>();
    default:
        return nullptr;
    } 
}