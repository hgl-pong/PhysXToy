...
void Renderer::InitializeImGui() {
	...
	colors[ImGuiCol_MenuBarBg] = ImVec4(0.15f, 0.15f, 0.17f, 0.80f);
	colors[ImGuiCol_ScrollbarBg] = ImVec4(0.15f, 0.15f, 0.17f, 0.60f);
	colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.28f, 0.28f, 0.28f, 0.30f);
	...
	colors[ImGuiCol_Header] = ImVec4(0.20f, 0.20f, 0.22f, 0.55f);
	colors[ImGuiCol_HeaderHovered] = ImVec4(0.26f, 0.26f, 0.28f, 0.80f);
	...
	colors[ImGuiCol_Tab] = ImVec4(0.20f, 0.20f, 0.22f, 0.86f);
	...
	colors[ImGuiCol_TabDimmed] = ImVec4(0.15f, 0.15f, 0.17f, 0.97f);
	colors[ImGuiCol_TabDimmedSelected] = ImVec4(0.25f, 0.25f, 0.25f, 1.00f);
	colors[ImGuiCol_TabDimmedSelectedOverline] = ImVec4(0.40f, 0.40f, 0.40f, 0.80f);

	colors[ImGuiCol_TabActive] = colors[ImGuiCol_TabSelected];
	colors[ImGuiCol_TabUnfocused] = colors[ImGuiCol_TabDimmed];
	colors[ImGuiCol_TabUnfocusedActive] = colors[ImGuiCol_TabDimmedSelected];
	...
	colors[ImGuiCol_NavHighlight] = colors[ImGuiCol_NavCursor];
