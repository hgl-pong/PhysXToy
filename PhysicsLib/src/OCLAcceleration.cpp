...
bool OCLAcceleration::InitPlatform(const unsigned int platformIndex)
{
...
bool OCLAcceleration::GetPlatformsInfo(std::vector<std::string>& info, const std::string& indentation)
{
...
bool OCLAcceleration::InitDevice(const unsigned int deviceIndex)
{
	cl_uint numDevices;
...
bool OCLAcceleration::GetDevicesInfo(std::vector<std::string>& info, const std::string& indentation)
{
	enum {
		DATA_TYPE_CL_UINT,
		DATA_TYPE_CL_BOOL,
